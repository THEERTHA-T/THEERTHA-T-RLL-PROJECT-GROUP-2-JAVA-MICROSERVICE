...
public class CustomerQueryApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        customerQuestionsRepository.save(new CustomerQuestions(null, "customer1@example.com", "Question 1", "Details 1", TodysDate.todayDate()));
        customerQuestionsRepository.save(new CustomerQuestions(null, "customer1@example.com", "Question 2", "Details 2", TodysDate.todayDate()));
